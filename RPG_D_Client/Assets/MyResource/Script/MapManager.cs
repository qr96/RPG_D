...
public class MapManager : MonoBehaviour
{
    ...
    public void SetMap(int mapId)
    {
        ...
        if (mapId == 1001)
        {
            ...
            {
                Managers.ui.GetLayout<UILayoutTriggerButton>().ShowButton("±§ªÍ¿‘¿Â",
                    () =>
                    {
            ...
            {
                Managers.ui.GetLayout<UILayoutTriggerButton>().ShowButton("ªÛ¡°¿ÃøÎ",
                    () =>
                    {
        ...
        else if (mapId == 1002)
        {
            ...
            portal.SetTriggerEnterEvent(() =>
            {
                Managers.ui.GetLayout<UILayoutTriggerButton>().ShowButton("≈Ω«Ë¡æ∑·",
                    () =>
                    {
